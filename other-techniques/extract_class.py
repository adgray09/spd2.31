...
class Food: 
    def __init__(self, name, prep_time, is_veggie, food_type, cuisine, ingredients):
        self.name = name
...
for key, value in foods.items():
    ...
    foods = Food(key, value[0], veggie, value[2], value[3], formatted)
    print(foods.name, "\n", "prep time is", foods.prep_time, "minutes", "\n", foods.is_veggie, "\n",  foods.food_type, "\n",  foods.cuisine, "\n",  foods.ingredients)
